...
// start 94
// document.body.style.cssText = `background-color: #ccc; text-transform: capitalize; margin: 0px 0px 0px 0px; `;
// document.title = "DOM IN JS";

// var div_header = document.createElement("div");
// div_header.style.cssText = `display: flex; justify-content: space-between; background-color: white; padding-left: 50px; padding-top: 15px; padding-right: 15px;`;
// var div = document.createElement("div");
// div_header.appendChild(div);
// var h1 = document.createElement("h1");
// h1.style.cssText = `margin-top: 0px; color: #197D51;`;
// div.appendChild(h1);
// var h1_text = document.createTextNode("elzero");
// h1.appendChild(h1_text);

// var div_flex = document.createElement("div");
// div_header.appendChild(div_flex);
// div_flex.style.cssText = `margin-top: 5px; display: flex; gap: 30px; transition: 0.5s;`;
// var a1 = document.createElement("a");
// var a1_text = document.createTextNode("home");
// var a2 = document.createElement("a");
// var a2_text = document.createTextNode("about");
// var a3 = document.createElement("a");
// var a3_text = document.createTextNode("service");
// var a4 = document.createElement("a");
// var a4_text = document.createTextNode("contact");
// a1.appendChild(a1_text);
// a2.appendChild(a2_text);
// a3.appendChild(a3_text);
// a4.appendChild(a4_text);
// a1.style.cssText = `text-decoration: none; color: black;`;
// a1.onmouseover = () => {
//     a1.style.cssText = `color: gold; cursor: pointer;`;
//     setInterval(() => {
//         a1.style.cssText = `color: black;`;
//     }, 500);
// }
// a2.style.cssText = `text-decoration: none; color: black;`;
// a2.onmouseover = () => {
//     a2.style.cssText = `color: gold; cursor: pointer;`;
//     setInterval(() => {
//         a2.style.cssText = `color: black;`;
//     }, 500);
// }
// a3.style.cssText = `text-decoration: none; color: black;`;
// a3.onmouseover = () => {
//     a3.style.cssText = `color: gold; cursor: pointer;`;
//     setInterval(() => {
//         a3.style.cssText = `color: black;`;
//     }, 500);
// }
// a4.style.cssText = `text-decoration: none; color: black;`;
// a4.onmouseover = () => {
//     a4.style.cssText = `color: gold; cursor: pointer;`;
//     setInterval(() => {
//         a4.style.cssText = `color: black;`;
//     }, 500);
// }
// div_flex.appendChild(a1);
// div_flex.appendChild(a2);
// div_flex.appendChild(a3);
// div_flex.appendChild(a4);

// document.body.appendChild(div_header);

// let mediaQuerySm = window.matchMedia(`(min-width: 410px)`);
// if (mediaQuerySm.matches) {
//     "";
// } else {
//     div_flex.style.cssText = `display: none;`;
//     var div_menu = document.createElement("div");
//     div_menu.style.cssText = `display: flex; justify-content: flex-end; margin-right: 20px; margin-top: -60px;`;
//     var div_cloumn = document.createElement("div");
//     var div_menu1 = document.createElement("div");
//     div_menu1.style.cssText = `background-color: black; width: 30px; height: 5px; margin-top: 8px;`;
//     var div_menu2 = document.createElement("div");
//     div_menu2.style.cssText = `background-color: black; width: 30px; height: 5px; margin-top: 8px;`;
//     var div_menu3 = document.createElement("div");
//     div_menu3.style.cssText = `background-color: black; width: 30px; height: 5px; margin-top: 8px;`;
//     div_menu.onclick = () => { div_flex.style.cssText = "display: flex; margin-top: 60px;" }
//     div_menu.ondblclick = () => { div_flex.style.cssText = "display: none;" }
//     div_cloumn.appendChild(div_menu1);
//     div_cloumn.appendChild(div_menu2);
//     div_cloumn.appendChild(div_menu3);
//     div_menu.appendChild(div_cloumn);
//     document.body.appendChild(div_menu);
// }
// var number = 1;
// for (let x = 0; x < 5; x++) {
//     var div_flex2 = document.createElement("div");
//     div_flex2.style.cssText = `display: flex; gap: 200px; padding-left: 35px; padding-right: 35px;`;
//     for (let i = 0; i <= 2; i++) {
//         var br = document.createElement("br");
//         document.body.appendChild(br);
//     }
//     for (let i = 0; i < 3; i++) {
//         var div_color1 = document.createElement("div");
//         div_color1.style.cssText = `border-radius: 6px; padding-top: 20px; padding-bottom: 20px; width: 100%; background-color: white; text-align: center;`;
//         div_flex2.appendChild(div_color1);
//         var div_h1 = document.createElement("h1");        
//         var div_text = document.createTextNode(number++);
//         div_h1.appendChild(div_text);
//         div_color1.appendChild(div_h1);
//         var color_span = document.createElement("span");
//         color_span.style.fontWeight = "bold";
//         var text_profile = document.createTextNode("profile");
//         color_span.appendChild(text_profile);
//         div_color1.appendChild(color_span);
//         document.body.appendChild(div_flex2);
//     }

//     let mediaQuerySm1 = window.matchMedia(`(min-width: 600px)`);
//     if (mediaQuerySm1.matches) {
//         "";
//     } else {
//         div_flex2.style.cssText = `flex-direction: column;`;
//     }
// }
// var br = document.createElement("br");
// document.body.appendChild(br);
// var div_footer = document.createElement("div");
// div_footer.style.cssText = `background-color: #197D51; color: white; height: 70px; display: flex; justify-content: center;`;
// var h1_footer = document.createElement("h1");
// var text_footer = document.createTextNode("copyright 2023");
// h1_footer.appendChild(text_footer);
// div_footer.appendChild(h1_footer);
// document.body.appendChild(div_footer);

// var link = document.querySelectorAll(".open");
// var link = document.querySelector(".open");
// var link = document.querySelector(".open");
// var link = document.querySelector(".open");

// for (let i = 0; i <= 5; i++) {
//     console.log(document.a[i]);
// document.images[i].alt = "Elzero Logo";
// console.log(document.images[i]);
// }

// console.log(link.href = "https://google.comElzero");

// var class_add = document.querySelector(".classes-to-add");
// var class_remove = document.querySelector(".classes-to-remove");
...
//         if (class_add.value) {
//             current.classList.add(class_add.value.toLowerCase().trim().split(" ")[i]);
//         }
//         if (class_remove.value) {
//             current.classList.remove(class_remove.value.toLowerCase().trim().split(" ")[i]);
//         }
//     }
//     this.value = "";
//     if (current.classList.length) {
//         [...current.classList].sort().forEach(elq => {
//             let clspan = document.createElement("span");
//             clspan.textContent = elq;
//             cls.append(clspan);
//         })
//     } else {
//         cls.textContent = "no classes to show";
//     }
// }
// class_add.onblur = my_add;
// class_remove.onblur = my_add;

// let Paragraph = document.querySelector("p");
// Paragraph.remove();

// let elemnt = document.querySelector(".our-element");
// let div_before = document.createElement("div");
// let div_before_text = document.createTextNode("start");
// div_before.appendChild(div_before_text);
// div_before.className = "start";
// div_before.title = "start element";
// div_before.setAttribute("data-value", "start");
// elemnt.before(div_before);

// let div_after = document.createElement("div");
// let div_after_text = document.createTextNode("end");
// div_after.appendChild(div_after_text);
// div_after.className = "end";
// div_after.title = "end element";
// div_after.setAttribute("data-value", "end");
// elemnt.after(div_after);
